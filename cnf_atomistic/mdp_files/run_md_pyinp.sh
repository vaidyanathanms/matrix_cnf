...
if ! test -f "index.ndx"; then
    echo "make groups.."
    srun gmx select -f confout_nvt_high.gro -s nvt_high.tpr -sf ../py_tcgrp -on index.ndx
fi
wait
...
wait
    ...
    srun gmx_mpi grompp -f nvt.mdp -c confout_nvt_high.gro -p py_topol -o nvt.tpr -n index.ndx
    wait
...
wait
    ...
    srun gmx_mpi grompp -f npt_berendsen.mdp -c confout_nvt.gro -p py_topol -o npt_berendsen.tpr -n index.ndx
    wait
...
wait
    ...
    srun gmx_mpi grompp -f npt_main.mdp -c confout_npt_berendsen.gro -p py_topol -o npt_main.tpr -n index.ndx
    wait
