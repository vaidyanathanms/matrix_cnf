...
# Uses 6AC3 patch from /toppar_all36_carb_imlab.str and BGLC from
# top_all36_carb.rtf 
...
# Loukas's cellulose code and then patch with 6AC3. This way there is
